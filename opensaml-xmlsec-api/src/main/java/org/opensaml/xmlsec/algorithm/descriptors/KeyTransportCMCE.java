...
/**
 * Algorithm descriptor for key transport algorithm: Classic McEliece.
 */
public final class KeyTransportCMCE implements KeyTransportAlgorithm {

    /** {@inheritDoc} */
    @Nonnull public String getKey() {
        return JCAConstants.KEY_ALGO_CMCE;
    }

    /** {@inheritDoc} */
    @Nonnull public String getURI() {
        return EncryptionConstants.ALGO_ID_KEM_CMCE;
    }
    ...
    @Nonnull public String getJCAAlgorithmID() {
        return JCAConstants.KEM_ALGO_CMCE;
    }
