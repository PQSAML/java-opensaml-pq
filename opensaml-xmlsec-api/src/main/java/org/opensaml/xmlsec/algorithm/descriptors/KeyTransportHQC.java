...
/**
 * Algorithm descriptor for key transport algorithm: HQC.
 */
public final class KeyTransportHQC implements KeyTransportAlgorithm {

    /** {@inheritDoc} */
    @Nonnull public String getKey() {
        return JCAConstants.KEY_ALGO_HQC;
    }

    /** {@inheritDoc} */
    @Nonnull public String getURI() {
        return EncryptionConstants.ALGO_ID_KEM_HQC;
    }
    ...
    @Nonnull public String getJCAAlgorithmID() {
        return JCAConstants.KEM_ALGO_HQC;
    }
