...
/**
 * Algorithm descriptor for key transport algorithm: Kyber.
 */
public final class KeyTransportKyber implements KeyTransportAlgorithm {

    /** {@inheritDoc} */
    @Nonnull public String getKey() {
        return JCAConstants.KEY_ALGO_KYBER;
    }

    /** {@inheritDoc} */
    @Nonnull public String getURI() {
        return EncryptionConstants.ALGO_ID_KEM_KYBER;
    }
    ...
    @Nonnull public String getJCAAlgorithmID() {
        return JCAConstants.KEM_ALGO_KYBER;
    }
