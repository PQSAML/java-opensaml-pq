...
/**
 * Algorithm descriptor for key transport algorithm: BIKE.
 */
public final class KeyTransportBIKE implements KeyTransportAlgorithm {

    /** {@inheritDoc} */
    @Nonnull public String getKey() {
        return JCAConstants.KEY_ALGO_BIKE;
    }

    /** {@inheritDoc} */
    @Nonnull public String getURI() {
        return EncryptionConstants.ALGO_ID_KEM_BIKE;
    }
    ...
    @Nonnull public String getJCAAlgorithmID() {
        return JCAConstants.KEM_ALGO_BIKE;
    }
